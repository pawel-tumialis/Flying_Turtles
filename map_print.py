...
weather_name = ''
path_to_train ='\data\trajectory_challenge\train_flights.csv'
...
def print_route_on_map(file):
    df = router_usefull_data(file)
    route = df.to_numpy()
...
route_name = '\data\trajectory_challenge\routes\{}'.format('flp_2A7i5CZ7tLiLnKGKgUeNFY.csv')

load_and_show_vil(weather_name)
print_route_on_map(route_name)